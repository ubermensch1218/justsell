...
description: Create audience-focused marketing content (Threads, LinkedIn, Instagram captions) using project 영업Info.md as source of truth.
---

# Content Creator (JustSell)

목표: 프로젝트의 `영업Info.md`를 기준으로 “훅 → 가치 → 증거 → CTA” 구조의 콘텐츠를 빠르게 만든다.

전제:
- 사실/수치/가격/일정은 `projects/<project>/영업Info.md`에만 의존한다.
