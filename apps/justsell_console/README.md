...
## Local logs
모든 로그는 로컬에 저장됩니다.
- 일반 로그: `~/.claude/.js/justsell/console/console.log`
- 이벤트 로그(JSONL): `~/.claude/.js/justsell/console/events/events-YYYY-MM-DD.jsonl`
- 채팅 로그(JSONL): `~/.claude/.js/justsell/console/events/chat-YYYY-MM-DD.jsonl`
- 잡 로그(JSONL): `~/.claude/.js/justsell/console/events/jobs-YYYY-MM-DD.jsonl`
...
- `~/.claude/.js/justsell/config.json`
