...
## Local logs
모든 로그는 로컬에 저장됩니다.
- 일반 로그: `~/.claude/.omc/justsell/console/console.log`
- 이벤트 로그(JSONL): `~/.claude/.omc/justsell/console/events/events-YYYY-MM-DD.jsonl`
- 채팅 로그(JSONL): `~/.claude/.omc/justsell/console/events/chat-YYYY-MM-DD.jsonl`
- 잡 로그(JSONL): `~/.claude/.omc/justsell/console/events/jobs-YYYY-MM-DD.jsonl`
...
- `~/.claude/.omc/justsell/config.json`
